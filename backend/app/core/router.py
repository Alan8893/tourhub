...
from app.modules.api.invitation_router import router as invitation_router
...
from app.modules.api.project_copy_router import router as project_copy_router
...
router.include_router(project_copy_router, dependencies=_preparation)
